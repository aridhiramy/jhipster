...
```
$ docker image tag gateway 172.16.23.89:5000/gateway
$ docker push 172.16.23.89:5000/gateway
$ docker image tag uaa 172.16.23.89:5000/uaa
$ docker push 172.16.23.89:5000/uaa
```
