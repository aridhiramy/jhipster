...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://gateway.jhipster.172.16.23.77"
        echo "Zipkin - http://zipkin.istio-system.172.16.23.77"
        echo "Grafana - http://grafana.istio-system.172.16.23.77"
        echo "Kiali - http://kiali.istio-system.172.16.23.77"
        echo "#####################################################"
}
